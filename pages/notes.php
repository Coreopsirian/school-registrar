...
<body>
  ...
  <aside id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-item active" data-href="notes.html" data-label="Notes"><span class="nav-icon"><i class="bi bi-journal-text"></i></span><span class="nav-text">Notes</span></div>
    </nav>
